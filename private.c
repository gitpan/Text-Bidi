...
XS(_wrap_log2vis) {
  {
    ...
    FriBidiCharType *arg4 = (FriBidiCharType *) 0 ;
    FriBidiStrIndex *arg5 = (FriBidiStrIndex *) 0 ;
    FriBidiStrIndex *arg6 = (FriBidiStrIndex *) 0 ;
    FriBidiLevel *arg7 = (FriBidiLevel *) 0 ;
    FriBidiCharType temp4 ;
    short _global_wantarray ;
    char *buf1 = 0 ;
    size_t size1 = 0 ;
    FriBidiStrIndex *_global_p_len ;
    FriBidiChar **temp3 ;
    FriBidiCharType temp40 ;
    int res4 = 0 ;
    FriBidiStrIndex **temp5 ;
    FriBidiStrIndex **temp6 ;
    FriBidiLevel **temp7 ;
    int argvi = 0;
    SV * _saved[1] ;
    dXSARGS;
    ...
    if ((items < 1) || (items > 2)) {
      SWIG_croak("Usage: log2vis(str,pbase_dirs);");
    }
    ...
    *_global_p_len = (FriBidiStrIndex)(size1/sizeof(FriBidiChar));
    ...
    if (items > 1) {
      if (!(SWIG_IsOK((res4 = SWIG_ConvertPtr(ST(1),SWIG_as_voidptrptr(&arg4),SWIGTYPE_p_int,0))))) {
        ...
        if (!SWIG_IsOK(ecode)) {
          SWIG_exception_fail(SWIG_ArgError(ecode), "in method '" "log2vis" "', argument " "4"" of type '" "FriBidiCharType""'");
        }
        temp40 = (FriBidiCharType)(val);
        arg4 = &temp40;
        res4 = SWIG_AddTmpMask(ecode);
      }
    }
    *temp3 = (FriBidiChar *)(malloc(sizeof(FriBidiChar) * ((*_global_p_len) + 1)));
    if ( _global_wantarray ) {
      *temp5 = (FriBidiStrIndex *)(malloc(sizeof(FriBidiStrIndex) * ((*_global_p_len) + 1)));
    }
    if ( _global_wantarray ) {
      *temp6 = (FriBidiStrIndex *)(malloc(sizeof(FriBidiStrIndex) * ((*_global_p_len) + 1)));
    }
    if ( _global_wantarray ) {
      *temp7 = (FriBidiLevel *)(malloc(sizeof(FriBidiLevel) * ((*_global_p_len) + 1)));
    }
    _saved[0] = ST(1);
    ...
    ST(argvi) = sv_2mortal(newSVpvn((const char *)(arg3), 
...
XS(_wrap_fribidi_log2vis_get_embedding_levels) {
  {
    ...
    if ((items < 1) || (items > 2)) {
      SWIG_croak("Usage: fribidi_log2vis_get_embedding_levels(str,pbase_dirs);");
    }
    buf1 = SvPV(ST(0), size1);
    *_global_p_len = (FriBidiStrIndex)(size1/sizeof(FriBidiChar));
    arg1 = (FriBidiChar *)(buf1);
    if (items > 1) {
      if (!(SWIG_IsOK((res3 = SWIG_ConvertPtr(ST(1),SWIG_as_voidptrptr(&arg3),SWIGTYPE_p_int,0))))) {
        ...
        int ecode = SWIG_AsVal_unsigned_SS_long SWIG_PERL_CALL_ARGS_2(ST(1), &val);
        if (!SWIG_IsOK(ecode)) {
          SWIG_exception_fail(SWIG_ArgError(ecode), "in method '" "fribidi_log2vis_get_embedding_levels" "', argument " "3"" of type '" "FriBidiCharType""'");
        }
        temp30 = (FriBidiCharType)(val);
        arg3 = &temp30;
        res3 = SWIG_AddTmpMask(ecode);
      }
    }
    if ( 1 ) {
      *temp4 = (FriBidiLevel *)(malloc(sizeof(FriBidiLevel) * ((*_global_p_len) + 1)));
    }
    _saved[0] = ST(1);
...
XS(_wrap_fribidi_remove_bidi_marks) {
  {
    ...
    if ((items < 1) || (items > 2)) {
      SWIG_croak("Usage: fribidi_remove_bidi_marks(inout,position_from_this_list);");
    }
    buf1 = SvPV(ST(0), size1);
    *_global_p_len = (FriBidiStrIndex)(size1/sizeof(FriBidiChar));
    arg1 = (FriBidiChar *)(buf1);
    if (items > 1) {
      if (SvOK(ST(1))) {
        ...
        buf = (AV*)(SvRV(ST(1)));
        size = av_len(buf) + 1;
        arg4 = (FriBidiStrIndex *)(malloc(size * sizeof(FriBidiStrIndex)));
        for(i=0;i < size; i++)
        arg4[i] = (FriBidiStrIndex)(SvUV(*(av_fetch(buf, i, 0))));
      }
    }
    _saved[0] = ST(0);
    _saved[1] = ST(1);
    ...
    ST(argvi) = sv_2mortal(newSVpvn((const char *)(arg1), 
...
XS(_wrap_fribidi_get_types) {
  {
    ...
    *_global_p_len = (FriBidiStrIndex)(size1/sizeof(FriBidiChar));
    arg1 = (FriBidiChar *)(buf1);
    if ( 1 ) {
      *temp3 = (FriBidiCharType *)(malloc(sizeof(FriBidiCharType) * ((*_global_p_len) + 1)));
    }
...
XS(_wrap_fribidi_cap_rtl_to_unicode) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: fribidi_cap_rtl_to_unicode(s);");
    }
    buf1 = SvPV(ST(0), size1);
    ...
    *temp3 = (FriBidiChar *)(malloc(sizeof(FriBidiChar) * ((*_global_p_len) + 1)));
    ...
    ST(argvi) = sv_2mortal(newSVpvn((char *)(arg3), 
        (STRLEN)( (result) * sizeof(FriBidiChar))));
    argvi++;
...
XS(_wrap_fribidi_unicode_to_cap_rtl) {
  {
    FriBidiChar *arg1 = (FriBidiChar *) 0 ;
    FriBidiStrIndex arg2 ;
    char *arg3 = (char *) 0 ;
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: fribidi_unicode_to_cap_rtl(str);");
    }
    buf1 = SvPV(ST(0), size1);
    *_global_p_len = (FriBidiStrIndex)(size1/sizeof(FriBidiChar));
    arg1 = (FriBidiChar *)(buf1);
    *temp3 = (char *)(malloc(2 * sizeof(char) * ((*_global_p_len) + 1)));
